...
let PhotoService = class PhotoService {
  ...
  loadSaved() {
    ...
    return (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const photoList = yield _capacitor_storage__WEBPACK_IMPORTED_MODULE_4__.Storage.get({
        key: _this.PHOTO_STORAGE
      });
      _this.photos = JSON.parse(photoList.value) || []; // If running on the web...

      if (!_this.platform.is('hybrid')) {
        // Display the photo by reading into base64 format
        for (let photo of _this.photos) {
  ...
  */
  ...
  addNewToGallery() {
    ...
    return (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const savedImageFile = yield _this2.savePicture(capturedPhoto); // Add new photo to Photos array

      _this2.photos.unshift(savedImageFile); // Cache all photo data for future retrieval


      _capacitor_storage__WEBPACK_IMPORTED_MODULE_4__.Storage.set({
  ...
  readAsBase64(photo) {
    ...
    return (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this4.platform.is('hybrid')) {
        ...
        const file = yield _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_3__.Filesystem.readFile({
          path: photo.path
        });
        return file.data;
      } else {
  ...
  deletePicture(photo, position) {
    ...
    return (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_3__.Filesystem.deleteFile({
        path: filename,
        directory: _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_3__.Directory.Data
      });
    })();
...
/* harmony import */ var _tab2_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tab2.page.scss?ngResource */ 81597);
    ...
    return (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const actionSheet = yield _this2.actionSheetController.create({
        ...
        buttons: [{
          ...
          icon: 'trash',
          handler: () => {
            _this2.photoService.deletePicture(photo, position);
          }
        }, {
          text: 'Cancel',
          icon: 'close',
...
Tab2Page = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
  selector: 'app-tab2',
...
const createCapacitor = win => {
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const loadPluginImplementation = /*#__PURE__*/function () {
      var _ref = (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,_home_fabrizio_Scrivania_ML_Project_WhatsMyAgeAgain_test_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
...
module.exports = ".prediction {\n  margin-top: 30px;\n}\n\nion-title {\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title> Photo Gallery </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Photo Gallery</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-card>\n    <ion-card-header>\n      <ion-button expand=\"block\" (click)=\"photoService.addNewToGallery()\"\n        >Take a Photo</ion-button\n      >\n    </ion-card-header>\n\n    <ion-grid>\n      <ion-col\n        size=\"6\"\n        *ngFor=\"let photo of photoService.photos; index as position\"\n      >\n        <ion-img\n          [src]=\"photo.webviewPath\"\n          (click)=\"showActionSheet(photo, position)\"\n        ></ion-img>\n        <ion-button expand=\"block\" color=\"danger\" class=\"prediction\"\n          >Make a prediction</ion-button\n        >\n      </ion-col>\n    </ion-grid>\n  </ion-card>\n</ion-content>\n";
